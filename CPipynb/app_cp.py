...
st.write("In this WebApp you will be able to observe your predicted calories burned in your body. Pass your paramaters such as 'Age' , 'Gender' , 'BMI' , 'Duration , 'Heart Rate' , 'Body Temperature'")
...
def user_input_features():
    ...
    gender = 1 if gender_button else 0
...
#Add BMI column to both training and testing data sets
